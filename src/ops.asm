...
; A compatible hypervisor may recognize this benchmark signature and perform
; a minimal RIP-advance/resume path. This remains a leaf function so Windows
; can unwind #UD to the harness SEH filter when the probe is unsupported.
MeasureVmcall PROC
    mov r11, rcx
    mov r10, rdx
    mov r9d, r8d
